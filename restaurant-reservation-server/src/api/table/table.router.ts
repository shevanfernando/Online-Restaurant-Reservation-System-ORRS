...
import { tableDTOObject } from '@api/table/table.dto';
import { HttpValidationError } from '@lib/HttpValidationError';
import tableService from './table.service';
import { filterTableDTOObject } from '@api/table/filter-table.dto';
import { freeTableDTOObject } from '@api/table/free-table.dto';
